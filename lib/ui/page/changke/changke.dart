  ...
  Widget build(BuildContext context) {
    ...
    final theme = rawTheme.copyWith(
        colorScheme: rawTheme.colorScheme
            .copyWith(onPrimary: Colors.white, primary: Color(0xff1DB6C2)));
    return Theme(
      data: theme,
                        ...
                        Expanded(
                          child: buildCardWithSemiCircle(
                            buttonGradient: LinearGradient(
                              ...
                              transform: GradientRotation(
                                  266.66 * 3.1416 / 180), // 设置渐变角度
                            ),
                            icon: SvgPicture.asset("assets/images/sign.svg",
                                color: Colors.white),
                            label: "签到",
                            onTap: () {
                              final url =
                                  "https://mobile.guet.edu.cn/ongoing-rollcall-list";
                              Get.toNamed(AppRoute.webView,
                                  arguments: WebViewArgs(url: url));
                            },
                          ),
